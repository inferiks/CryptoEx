  ...
  return (
    <>
      <header className="header">
        <Link to="/">
          <svg className="header-logo" width="64px" height="64px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className={`mobile-menu ${menuOpen ? 'mobile-menu--open' : ''}`}>
        <MUILink href="/" underline="none" className="mobile-menu__el" color="black" onClick={toggleMenu}>Buy crypto</MUILink>
        <MUILink href="/aboutUs" underline="none" className="mobile-menu__el" color="black" onClick={toggleMenu}>About us</MUILink>
        <MUILink href="/reviews" underline="none" className="mobile-menu__el" color="black" onClick={toggleMenu}>Reviews</MUILink>
        <a href="https://t.me" target="_blank" className="mobile-menu__el mobile-menu__telegram" onClick={toggleMenu}>
          <img src={telegram} alt="Telegram" />
          Telegram
        </a>
      </div>
